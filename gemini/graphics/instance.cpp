...
void Instance::create()
{
    ...
    CHECK_VK_RESULT(vkCreateInstance(&instanceInfo, nullptr, &m_instance), "Failed to create instance!");
...
void Instance::checkValidationLayerSupport()
{
    ...
    for (const char* layerName : m_validationLayers)
    {
        ...
        if (!isFound)
        {
            LOG("Failed to find validation layers");
        }
    }
}
...
void Instance::createDebugMessenger()
{
    ...
    CHECK_VK_RESULT(createDebugUtilsMessengerEXT(m_instance, &messengerInfo, nullptr, &m_debugMessenger), 
